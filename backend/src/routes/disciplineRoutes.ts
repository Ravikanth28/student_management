...
import { createDisciplineRecord, listDisciplineRecords, disciplineSummary, deleteDisciplineRecord, deleteBatchDisciplineRecords, clearAllDisciplineRecords } from '../controllers/disciplineController.js';
...
disciplineRoutes.post('/batch-delete', deleteBatchDisciplineRecords);
