...
import { createLateRecord, listLateRecords, lateSummary, deleteLateRecord, deleteBatchLateRecords, deleteAllLateRecords } from '../controllers/lateController.js';
...
lateRoutes.post('/batch-delete', deleteBatchLateRecords);
lateRoutes.get('/summary', lateSummary);
lateRoutes.get('/', listLateRecords);
lateRoutes.delete('/all', deleteAllLateRecords);
lateRoutes.delete('/', deleteAllLateRecords);
